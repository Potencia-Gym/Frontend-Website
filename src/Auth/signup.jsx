    ...
    <div className="flex flex-col md:flex-row h-screen items-center bg-black font-font1">
      ...
      <div className="bg-black text-white w-full md:max-w-md lg:max-w-full md:mx-auto md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12 flex items-center justify-center">
        <div className="w-full h-100">
          <h1 className="text-xl md:text-2xl font-bold mt-12 text-green">
          ...
          <button
            ...
            type="button"
            className="w-full block bg-black hover:bg-gray-900 text-gray-100 font-semibold rounded-lg px-4 py-3 border border-green"
          >
            <div className="flex items-center justify-center">
              {!loggingIn && (
                <span className="ml-4">
                  <FcGoogle className="inline text-xl mr-2" />
                  Sign Up with Google
                </span>
              )}
              ...
              {loggingIn && (
                <div role="status" className="flex justify-center items-center">
                  <svg
                    aria-hidden="true"
                    className="inline w-7 h-7 text-gray-200 animate-spin dark:text-gray-600 fill-green"
                    viewBox="0 0 100 101"
                    fill="none"
                  ...
                  <span className="text-xl px-3 dark:text-white tracking-wide">
                    Loading...
                  </span>
                </div>
              )}
